# ------------------------------------------------------------------------------
# Test suite for PCG solver + diagonal matrix-free operators for generalized additive P-splines
# ------------------------------------------------------------------------------
...
W2 <- exp(2*mvp_Phi_terms(PhiT_terms, alpha_terms))
...
Phi <- t(PhiT_full)
PhiT_W_Phi_full <- PhiT_full %*% diag(W2) %*% Phi
